...
export const InputSelect: React.FC<InputSelectProps> = ({
    helperText, error = false, height = false, main = false, clear, 
    name = false, bgcolor = false, changedesign = false, options,
    onChange, value, style, label = "Choose", ...rest }) => {
            ...
            <CustomSelect ref={dropdownRef} style={style}>
                ...
                >
                    <Text style={{ fontWeight: main ? 700 : 500 }}>{name ? (
                        <div style={{ display: "flex" }}><p style={{ margin: "0 5px", color: "#A0AEC0" }}>{label} : </p>{selectedItem}</div>
